...
describe("the scrim", () => {
  ...
  it("is a token at all — no component may paint its own", () => {
    ...
    // in dialog.tsx and drawer.tsx. The component half was
    // `system-vocabulary.test.ts`, deleted with `packages/ui` at 0.3.0 — this
    // is the only half left, and it is the theme half.
