#!/usr/bin/env node
/**
 * flutter/lumo_ui_mobile/lib/src/tokens.g.dart (Lumo UI Mobile) is GENERATED from packages/theme/src/tokens.css:
...
const OUT = process.argv.includes("--out") ? process.argv[process.argv.indexOf("--out") + 1] : join(ROOT, "flutter", "lumo_ui_mobile", "lib", "src", "tokens.g.dart");
