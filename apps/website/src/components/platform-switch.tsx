...
const COPY = {
  "fa-IR": { group: "پلتفرم", web: "وب", mobile: "موبایل (فلاتر)" },
  "en-US": { group: "Platform", web: "Web", mobile: "Mobile (Flutter)" },
 ...
 *
 * «فلاتر» is Flutter TRANSLITERATED, not the Latin brand: this label is both
 * visible text and an accessible name on a Persian page, and `native-script-text`
 * and `native-script-name` grade it. The engine's Latin name belongs in the
 * page's prose, inside a sentence, where a translator can see it.
 */
