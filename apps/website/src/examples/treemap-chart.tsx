...
export const EXAMPLES: ComponentExamples = { meta: { usage: { when: { "fa-IR": "سلسله‌مراتب به‌شکل مساحت تناسبی: مصرف دیسک، بودجه بر حسب واحد، سهم بازار.", "en-US": "A hierarchy as proportional area: disk usage, budget by department, market share." }, whenNot: { "fa-IR": "ماتریس — `HeatmapChart`. مقدارها روی یک محور — `ChartContainer`. جریان میان گره‌ها — `SankeyChart`.", "en-US": "A matrix — `HeatmapChart`. Values over an axis — `ChartContainer`. Flow between nodes — `SankeyChart`." } }, isNew: true, tier: "data", title: { "fa-IR": "نمودار درختی", "en-US": "Treemap chart" }, intro: { "fa-IR": "سلسله‌مراتب را به مساحت تبدیل می‌کند، بدون تغییر دادن ردیف‌های ورودی.", "en-US": "Turns hierarchy into proportional area without mutating the authored rows." }, composition: "<TreemapChart locale label dataCaption parentLabel valueLabel data />", parts: [{ name: "TreemapChart", description: { "fa-IR": "چیدمان سلسله‌مراتبی پاسخ‌گو با برچسب‌های درون سلول.", "en-US": "A responsive hierarchical layout with fitted in-cell labels." } }] }, examples: [{ id: "share", title: { "fa-IR": "ترکیب محصول", "en-US": "Product composition" }, render: ShareExample }] };
