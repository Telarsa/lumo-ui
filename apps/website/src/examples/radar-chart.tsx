...
export const EXAMPLES: ComponentExamples = {
  meta: { isNew: true, tier: "data", title: { "fa-IR": "نمودار راداری", "en-US": "Radar chart" }, intro: { "fa-IR": "مقایسهٔ چند نمایه روی دامنه‌ای صریح؛ هر مقدار در جدول سرورشده هم می‌آید.", "en-US": "Compare profiles over an explicit domain; every value also appears in the server-rendered table." }, composition: "<RadarChart locale label dataCaption dimensionLabel maxValue series data />", parts: [{ name: "RadarChart", description: { "fa-IR": "نمایهٔ قطبی سطح‌بالا با چند سری و راهنمای مشترک.", "en-US": "A high-level polar profile with multiple series and one shared legend." } }] },
