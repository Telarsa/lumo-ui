...
const COPY = {
  "fa-IR": {
    ...
    sections: [
      { id: "tiers", label: "سه لایهٔ توکن" },
      { id: "brand", label: "برندسازی با دو پیچ" },
      { id: "default", label: "پیش‌فرض بی‌رنگ" },
      { id: "states", label: "سه حالت، نه دو" },
      { id: "bridge", label: "پل Tailwind" },
    ],
  },
  "en-US": {
    title: "Theming",
    ...
    sections: [
      { id: "tiers", label: "The three token tiers" },
      { id: "brand", label: "Branding with two knobs" },
      { id: "default", label: "The achromatic default" },
      { id: "states", label: "Three states, not two" },
      { id: "bridge", label: "The Tailwind bridge" },
    ],
  },
...
export default async function ThemingPage({
  ...
  return (
    <DocsShell lang={lang} slug="theming" title={t.title} intro={t.intro} sections={t.sections}>
      <DocSection id="tiers" title={fa ? "سه لایهٔ توکن" : "The three token tiers"}>
        <P>
          {fa ? (
            <>
      ...
      <DocSection id="brand" title={fa ? "برندسازی با دو پیچ" : "Branding with two knobs"}>
        <P>
          {fa ? (
            <>
      ...
      <DocSection id="default" title={fa ? "پیش‌فرض بی‌رنگ" : "The achromatic default"}>
        <P>
          {fa ? (
            <>
      ...
      <DocSection id="states" title={fa ? "سه حالت، نه دو" : "Three states, not two"}>
        <P>
          {fa ? (
            <>
      ...
      <DocSection id="bridge" title={fa ? "پل Tailwind" : "The Tailwind bridge"}>
        <P>
          {fa ? (
            <>
