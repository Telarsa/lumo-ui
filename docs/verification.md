...
| `mutation:components` (CI job) | 111 modules each kill one mutant via `vitest related` — a floor of one operator per module, mostly class-strip plus behavioral operators for high-risk modules | Behavioral mutation breadth |
